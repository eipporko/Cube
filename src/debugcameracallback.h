...
#ifndef __CUBE__debugcameracallback__
#define __CUBE__debugcameracallback__

#include "camera.h"

class DebugCameraCallback : public CameraCallback {
...
public:
    DebugCameraCallback() : CameraCallback() {};
    void operation();
};
