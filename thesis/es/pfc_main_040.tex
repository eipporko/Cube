...
%
\chapter[Diseno de un visualizador]{
	Diseño de un visualizador
...
Una vez definidos los requerimientos, se pasó a diseñar un esqueleto el cual se podrá ver en el siguiente diagrama de clases (ver Figura \ref{figure_diagram_class}):
\begin{figure}
	\centering
...
El objetivo de la clase \textbf{VAO} será la de almacenar los modelos que se carguen. Estos almacenaran los datos de la nube (posición, color, normal y radios) además de encargarse de reservar la memoria en la tarjeta gráfica y enviar la información para su procesado por el \textit{pipeline}.
