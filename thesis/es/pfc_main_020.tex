...
En este capítulo se explicarán los fundamentos tenológicos necesarios para la comprensión de este proyecto. Empezando por la explicación de las Nubes de puntos (ver \ref{s_nubes}), OpenGL (ver \ref{s_opengl}) y la librería PCL (ver \ref{s_pcl}).
